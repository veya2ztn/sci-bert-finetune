...
def get_tasks_args(parser):
    ...
    group.add_argument('--seq-length-ret', type=int, default=None,
                       help='')
    group.add_argument('--train-hard-neg', type=int, default=None,
                       help='')
    group.add_argument('--val_av_rank_hard_neg', type=int, default=None,
                       help='')
    group.add_argument('--val_av_rank_other_neg', type=int, default=None,
                       help='')
    return parser
