...
from tasks.dense_retriever.supervised_training.train_dense_retriever import accuracy_func_provider
from tasks.dense_retriever.supervised_training.train_dense_retriever import train
