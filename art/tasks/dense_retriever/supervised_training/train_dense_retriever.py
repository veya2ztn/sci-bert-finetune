...
class CustomDataLoader(DataLoader):
    ...
    def _collate_fn(self, batch_data):
        ...
        tensorized['query'] = torch.LongTensor(np.stack(tensorized['query']))
        tensorized['query_mask'] = torch.LongTensor(np.stack(tensorized['query_mask']))
        tensorized['query_types'] = torch.LongTensor(np.stack(tensorized['query_types']))
        tensorized['query_pad_mask'] = torch.LongTensor(np.stack(tensorized['query_pad_mask']))

        tensorized['context'] = torch.LongTensor(np.stack(tensorized['context']))
        tensorized['context_mask'] = torch.LongTensor(np.stack(tensorized['context_mask']))
        tensorized['context_types'] = torch.LongTensor(np.stack(tensorized['context_types']))
        tensorized['context_pad_mask'] = torch.LongTensor(np.stack(tensorized['context_pad_mask']))
