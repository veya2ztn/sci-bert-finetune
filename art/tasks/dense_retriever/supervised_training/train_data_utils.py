...
def build_tokens_types_paddings_from_text(query, context,
    ...
    query_ids, query_types, query_pad_mask = build_tokens_types_paddings_from_ids(query_ids,
                                                                                  max_seq_length,
                                                                                  tokenizer.cls,
                                                                                  tokenizer.sep,
                                                                                  tokenizer.pad)
    ...
    ctx_ids, ctx_types, ctx_pad_mask = build_tokens_types_paddings_from_ids(extended_ctx_ids,
                                                                            max_seq_length,
                                                                            tokenizer.cls,
                                                                            tokenizer.sep,
                                                                            tokenizer.pad)
...
def build_sample(query_ids, query_types, query_pad_mask, ctx_ids, ctx_types, ctx_pad_mask, answers,
                 neg_ctx_id_list=None, neg_ctx_types_list=None, include_neg=False):
