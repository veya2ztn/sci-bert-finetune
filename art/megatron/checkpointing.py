...
def load_dualencoder_checkpoint(model, only_query_model=False, only_context_model=False,
    ...
    if 'retriever/biencoder_model' in state_dict:
        state_dict = state_dict['retriever/biencoder_model']
    if only_query_model and 'context_model' in state_dict:
        state_dict.pop('context_model')
    if only_context_model and 'query_model' in state_dict:
