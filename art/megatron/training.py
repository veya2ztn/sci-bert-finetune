...
def training_log(loss_dict, total_loss_dict, learning_rate, iteration,
    ...
    add_to_logging('forward-get-query-embedding')
    add_to_logging('forward-get-topk-embedding')
    add_to_logging('forward-get-answer-embedding')
    add_to_logging('forward-get-answer-score')
    add_to_logging('forward-get-LLM-score')
